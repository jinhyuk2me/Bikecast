...
> EDA를 통해 시간·환경·공간 요인이 수요에 영향을 미친다는 사실을 확인하였고,  
> 이를 바탕으로 각각의 요인을 입력 변수로 활용하는 두 가지 기능을 설계하였습니다.
...
- 다만, 고수요 대여소(일수요 > 100)에 대해서는 성능 개선이 필요하며, 그 구조적 한계에 대해서는 [8. 고찰 및 한계](#8-고찰-및-한계)에서 다루었습니다.
